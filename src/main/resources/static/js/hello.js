angular.module('hello', [ 'ngRoute' ]).config(function($routeProvider, $httpProvider) {
   ...
   $httpProvider.defaults.withCredentials = true;
...
}).controller('navigationController',function($rootScope, $http, $location, $route,$scope) {
		...
		}).controller('homeController', function($http,$scope,$rootScope,$location) {
			var self = this;
...
}).controller('subscriptionController', function($http,$scope,$rootScope,$location) {
